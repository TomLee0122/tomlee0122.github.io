...
杠是指**四张相同的牌**，比如四张五筒、四张南风等。**所有牌**都可以用于组成暗杠。杠根据形成过程不同，可分为明杠、暗杠、加杠（又称补杠）三种类型。下三图展示了三种杠的样式。<span class="small-text" style="color: gold;">*宝牌的气息！*</span>
...
麻将是追求和牌的游戏，和牌必须满足和牌的条件。除去极特殊的牌型外，和牌的条件是：摸到一张牌后，手中的牌恰好包括四组面子与一对雀头（自摸）<span class="small-text" style="color: gray;">*自摸喵！*</span>；或者在他人打出一张牌后，自己手中的牌与刚刚打出的这张牌恰好可以组成四组面子与一对雀头（荣和）<span class="small-text" style="color: gray;">*荣喵！*</span>。无论手中的牌怎么组合，只要能够满足上述四组面子与一对雀头的条件，就可以和牌。当然了，每张牌只能使用一次！下图展示了几种和牌的情形。
...
<div style="text-align: center;">
  ...
  <figcaption style="margin-top: 1.5em;">图2.3.1：听牌图一，听牌：四条、七条</figcaption>
</div>

<div style="text-align: center;">
  <img src="/assets/images/Creatures/Mahjong/tingpai_2.png" alt="" style="max-width: 100%; height: auto">
  <figcaption style="margin-top: 1.5em;">图2.3.2：听牌图二，听牌：三万、六万</figcaption>
</div>

<div style="text-align: center;">
  <img src="/assets/images/Creatures/Mahjong/tingpai_3.png" alt="" style="max-width: 100%; height: auto">
  <figcaption style="margin-top: 1.5em;">图2.3.3：听牌图三，听牌：白、白</figcaption>
</div>